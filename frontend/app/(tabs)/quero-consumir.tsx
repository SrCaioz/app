...
export default function QueroConsumirScreen() {
  ...
  const filtered = useMemo(() => {
    let list = items.filter((x) => x.in_watchlist);
  ...
  return (
    <View style={[styles.container, { paddingTop: insets.top }]}>
      <View style={styles.header}>
        <Text style={styles.title}>Quero Consumir</Text>
      ...
      {filtered.length === 0 ? (
        <EmptyState
          ...
          subtitle="Salve títulos para consumir mais tarde."
